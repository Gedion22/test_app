...
import {removeUser, setCurrentUser} from '../../../app/actions/users';
    ...
    const renderItem = useCallback(
        (item: TUser) => (
            <View key={item.id} style={styles.itemWrapper}>
                <UserItem onRemove={handleRemoveUser} onClick={handleClickUser} item={item} />
            </View>
        ),
        [handleClickUser, handleRemoveUser],
    );
